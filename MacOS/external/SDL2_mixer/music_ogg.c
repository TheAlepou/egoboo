...
/* ov_callbacks.seek_func expects int return: 0 on success, nonzero on failure. */
...
/* ov_callbacks.tell_func expects long return. Clamp/cast SDL_RWtell result safely. */
static long sdl_tell_func(void *datasource)
{
    ...
    /* Cast to long; on LP64 macOS long is 64-bit, but clamp just in case. */
