...
// Fallbacks for C environments lacking these macros/types when compiling as C.
#ifndef __cplusplus
  #ifndef bool
    #include <stdbool.h>
  #endif
...
// Ensure ASCII constants exist if not provided by other headers.
#ifndef ASCII_LINEFEED_CHAR
  #define ASCII_LINEFEED_CHAR '\n'
#endif
#ifndef C_CARRIAGE_RETURN_CHAR
  #define C_CARRIAGE_RETURN_CHAR '\r'
#endif
#ifndef C_TAB_CHAR
  #define C_TAB_CHAR '\t'
#endif
#ifndef C_DOUBLE_QUOTE_CHAR
...
// Provide minimal forward declaration for vfs_FILE if not included yet.
#ifndef HAVE_VFS_FILE_FORWARD
#define HAVE_VFS_FILE_FORWARD 1
typedef struct vfs_FILE vfs_FILE;
#endif

// If this file is compiled as C, but uses C++ namespaces like std and Ego, enforce C++ compilation.
#if !defined(__cplusplus)
  #error "This file requires a C++ compiler (due to use of namespaces, std::, and classes). Please compile as C++."
#endif

#include "script_compile.h"
#include "game.h"
#include "egoboo.h"
#include "Script/CLogEntry.hpp"

// Ensure we can use std:: in this translation unit
#include <limits>
#include <vector>
#include <algorithm>
#include <string>
...
vfs_FILE *debug_script_file = nullptr;
...
static void print_line()
{
    // This debug helper is disabled in release; kept empty to satisfy linker when enabled.
}
#endif
