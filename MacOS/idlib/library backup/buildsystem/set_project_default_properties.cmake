...
if (IDLIB_IS_MULTI_TARGET_GENERATOR)
	...
	foreach( OUTPUTCONFIG ${CMAKE_CONFIGURATION_TYPES} )
		...
		# single-target generator path...
		# The name of the output platform as used in the pathnames.
		if (IDLIB_PLATFORM_ID STREQUAL "X64")
		set(OUTPUTPLATFORM_FOLDER_NAME "x64")
		elseif (IDLIB_PLATFORM_ID STREQUAL "X86")
		set(OUTPUTPLATFORM_FOLDER_NAME "x86")
		elseif (IDLIB_PLATFORM_ID STREQUAL "ARM64")
		set(OUTPUTPLATFORM_FOLDER_NAME "arm64")
		else()
		message(FATAL_ERROR "unhandled enumeration element: IDLIB_PLATFORM_ID='${IDLIB_PLATFORM_ID}'")
		endif()
