...
# --- Robust compiler-id mapping (always numeric) ---
# Known numeric enums:
#   IDLIB_CXX_COMPILER_ID_UNKNOWN 0
#   IDLIB_CXX_COMPILER_ID_CLANG   1
#   IDLIB_CXX_COMPILER_ID_MSVC    2
#   IDLIB_CXX_COMPILER_ID_GCC     3

unset(IDLIB_CXX_COMPILER_ID CACHE)
...
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  ...
  set(IDLIB_CXX_COMPILER_ID ${IDLIB_CXX_COMPILER_ID_UNKNOWN})
endif()
...
# --- AppleClang / ARM64 fallback detection ---
if (NOT DEFINED IDLIB_CXX_COMPILER_ID)
  if (CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
    set(IDLIB_CXX_COMPILER_ID "APPLECLANG")
  elseif (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    set(IDLIB_CXX_COMPILER_ID "CLANG")
  elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    set(IDLIB_CXX_COMPILER_ID "GCC")
  elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    set(IDLIB_CXX_COMPILER_ID "MSVC")
  endif()
endif()

# Normalize architecture
if (NOT DEFINED IDLIB_PLATFORM_ID)
  # CMAKE_OSX_ARCHITECTURES may be ;-separated (e.g., "arm64;x86_64")
  if (CMAKE_SYSTEM_PROCESSOR MATCHES "arm64|aarch64"
      OR CMAKE_OSX_ARCHITECTURES MATCHES "arm64")
    set(IDLIB_PLATFORM_ID "ARM64")
  elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64"
      OR CMAKE_OSX_ARCHITECTURES MATCHES "x86_64")
    set(IDLIB_PLATFORM_ID "X64")
  else()
    set(IDLIB_PLATFORM_ID "UNKNOWN")
  endif()
endif()
...
macro(idlib_report_cxx_compiler_id)
  ...
  elseif (${IDLIB_CXX_COMPILER_ID} EQUAL ${IDLIB_CXX_COMPILER_ID_UNKNOWN})
    ...
    message(ERROR "unhandled enumeration element")
  endif()
endmacro()
